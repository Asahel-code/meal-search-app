...
<template>
	<div class="border border-gray-400 rounded shadow animate-pulse">
		<div class="flex items-center justify-center h-48 mb-4 bg-gray-400 rounded">
			<svg
				viewBox="0 0 16 20"
				fill="currentColor"
				...
				<path
					d="M5 5V.13a2.96 2.96 0 0 0-1.293.749L.879 3.707A2.98 2.98 0 0 0 .13 5H5Z"></path>
			</svg>
		</div>
		<div class="mx-4">
